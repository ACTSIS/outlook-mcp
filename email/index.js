...
const emailTools = [
  ...
  },
  {
    name: 'delete-email',
    description:
      'Deletes an email by moving it to Deleted Items (trash). Use permanent=true to hard delete.',
    inputSchema: {
      type: 'object',
      properties: {
        id: {
        ...
        permanent: {
          type: 'boolean',
          description:
            'If true, permanently delete the email instead of moving to Deleted Items. Default: false',
        },
      },
      required: ['id'],
    },
